...
// Footer General
$this->sections['ambersix_footer_widget_general'] = array(
	'title' => esc_html__( 'General', 'ambersix' ),
	'panel' => 'ambersix_footerwidget',
	'settings' => array(
		array(
			'id' => 'footer_widgets',
			'default' => true,
		...
		array(
			...
			'control' => array(
				...
				'label' => esc_html__( 'Title Widget', 'ambersix' ),
				'active_callback' => 'ambersix_cac_has_footer_widgets'
			),
		),
		array(
			...
			'control' => array(
				'type' => 'text',
				'label' => esc_html__( 'Title Widget: Margin', 'ambersix' ),
		...
		array(
			...
			'control' => array(
				'type' => 'color',
				'label' => esc_html__( 'Title Widget: Color', 'ambersix' ),
				'active_callback' => 'ambersix_cac_has_footer_widgets'
			),
			'inline_css' => array(
				'target' => '#footer-widgets .widget .widget-title',
...
$this->sections['ambersix_footer_widget_search'] = array(
	'title' => esc_html__( 'Widget: Search', 'ambersix' ),
	'panel' => 'ambersix_footerwidget',
	'settings' => array(
		array(
			...
			'control' => array(
				'type' => 'color',
				'label' => esc_html__( 'Icon Color', 'ambersix' ),
			),
			'inline_css' => array(
...
$this->sections['ambersix_footer_widget_built_in'] = array(
	'title' => esc_html__( 'Widget: Categories, Archives, Meta...', 'ambersix' ),
	'panel' => 'ambersix_footerwidget',
	'settings' => array(
		array(
			...
			'control' => array (
				'type' => 'text',
				'label' => esc_html__( 'Item Padding', 'ambersix' ),
				'description' => esc_html__( 'Top Right Bottom Left. Ex: 13px 0px 13px 0px', 'ambersix' ),
			),
			'inline_css' => array(
				'target' => array(
		...
		array(
			...
			'control' => array(
				'type' => 'color',
				'label' => esc_html__( 'Links Color', 'ambersix' ),
			),
			'inline_css' => array(
				'target' => array(
...
// Footer Widget Tags
$this->sections['ambersix_footer_widget_tags'] = array(
	'title' => esc_html__( 'Footer Widget: Tags', 'ambersix' ),
	'panel' => 'ambersix_footerwidget',
	'settings' => array(
		array(
			...
			'control' => array (
				...
				'description' => esc_html__( 'Top Right Bottom Left. Ex: 2px 8px 2px 8px', 'ambersix' ),
			),
			'inline_css' => array(
		...
		array(
			...
			'control' => array(
				'type' => 'text',
				'label' => esc_html__( 'Rounded', 'ambersix' ),
				'description' => esc_html__( '0px is square.', 'ambersix' ),
			),
			'inline_css' => array(
		...
		array(
			...
			'control' => array(
				...
				'description' => esc_html__( 'Example: 6px.', 'ambersix' ),
			),
			'inline_css' => array(
				'target' => '#footer-widgets .widget.widget_tag_cloud .tagcloud a',
				'alter' => array(
...
// Footer Widget Links
$this->sections['ambersix_footer_widget_links'] = array(
	'title' => esc_html__( 'Footer Widget: Links', 'ambersix' ),
	'panel' => 'ambersix_footerwidget',
	'settings' => array(
		array(
			...
			'control' => array (
				'type' => 'text',
				'label' => esc_html__( 'Padding', 'ambersix' ),
				'description' => esc_html__( 'Top Right Bottom Left. Ex: 10px 0px 10px 0px', 'ambersix' ),
			),
			'inline_css' => array(
