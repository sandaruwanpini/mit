...
if ( ! class_exists( 'Ambersix_Sanitize_Data' ) ) {
	class Ambersix_Sanitize_Data {
...
// Helper function runs the Ambersix_Sanitize_Data class
function ambersix_sanitize_data( $data = '', $type = '' ) {
	if ( $data && $type ) {
		$class = new Ambersix_Sanitize_Data();
