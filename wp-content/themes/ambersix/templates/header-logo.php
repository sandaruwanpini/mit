...
switch ( $header_style ) {
    case "style-2":
		$logo_img = ambersix_get_mod( 'custom_logotwo' );
		$logo_width = ambersix_get_mod( 'logotwo_width' );
        break;
    case "style-3":
		$logo_img = ambersix_get_mod( 'custom_logothree' );
		$logo_width = ambersix_get_mod( 'logothree_width' );
        break;
    case "style-4":
		$logo_img = ambersix_get_mod( 'custom_logofour' );
		$logo_width = ambersix_get_mod( 'logofour_width' );
        break;
    case "style-5":
		$logo_img = ambersix_get_mod( 'custom_logofive' );
		$logo_width = ambersix_get_mod( 'logofive_width' );
        break;
    case "style-6":
		$logo_img = ambersix_get_mod( 'custom_logosix' );
		$logo_width = ambersix_get_mod( 'logosix_width' );
        break;
    default:
		$logo_img = ambersix_get_mod( 'custom_logo' );
		$logo_width = ambersix_get_mod( 'logo_width' );
}

if ( is_page() && $custom_logo = ambersix_metabox('custom_header_logo') )
