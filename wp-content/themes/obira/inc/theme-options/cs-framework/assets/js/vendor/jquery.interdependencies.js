...
(function($) {
    ...
    $.extend(Rule.prototype, {
        ...
        /**
         * Unova the condition of this rule in given jQuery context.
         *
         * The widget value is extracted using getControlValue()
         *
         * @param {jQuery} context The jQuery selection in which this rule is unovad.
         *
         */
         ...
         * @param  {Object} enforced Recursive rule enforcer: undefined to unova condition, true show always, false hide always
         *
         */
